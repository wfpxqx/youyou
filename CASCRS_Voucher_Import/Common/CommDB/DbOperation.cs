...
namespace CASCRS_Voucher_Import.Common.CommDB
{
	/// <summary>
	/// 数据库操作类
	/// </summary>
	public class DbOperation
	{
		...
		public static string connectionString1 = ConfigurationManager.AppSettings["CASCRS_DB_U8_CONN1"].ToString();
		public static string connectionString2 = ConfigurationManager.AppSettings["CASCRS_DB_U8_CONN2"].ToString();
		//定义SqlConnection
		...
		/// 连接数据库
		/// </summary>
		private static void GetConnection1()
		{
			try
			{
				objSqlConn = new SqlConnection(connectionString1);
				objSqlConn.Open();
			}
			catch (Exception ex)
			{
		...
		/// 连接数据库
		/// </summary>
		private static void GetConnection2()
		{
			try
			{
				objSqlConn = new SqlConnection(connectionString2);
				objSqlConn.Open();
			}
			catch (Exception ex)
			{
